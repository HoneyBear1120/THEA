...
import upload_icon from '../Assets/images/Groceries.png'
                                    ...
                                    <div className="col-lg-12 col-xl-9 custom-field">
                                        <div className="cs_card_style">
                                            <div className="card-header">
                                                <input type="text" name="search" className="form-control placeholder-black input_title" placeholder="Note" />
                                            </div>
                                            <div className="card-body">
                                                <div className="position-relative">
                                                    <textarea className="text_area f_out textarea-height" id="exampleFormControlTextarea1" placeholder="new field" />
