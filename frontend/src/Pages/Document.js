...
import upload_icon from '../Assets/images/document.png'
                                        ...
                                        <div className="row justify-content-lg-center ">
                                            <div className="col-xl-9 padding-header">
                                                <div className="row">
                                                    ...
                                                    <div className="col">
                                                       <form class="icon_export">
                                                            <input type="text" name="search" className="input_title_header f_out" value="Title" />
                                    ...
                                    <div className="col-lg-12 col-xl-9 custom-field">
                                        <div className="cs_card_style">
                                            <div className="card-header">
                                                <input type="text" class="form-control placeholder-black input_title" placeholder="Document" />
                                            </div>
                                                ...
                                                <div className="form-group">
                                                    <div className="row">
                                                        <div className="col-sm-5 col-lg-5  col-xl-4">
                                                            <input type="text" className="input_cs f_out" placeholder="custom" />
                                                        </div>
