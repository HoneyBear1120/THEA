...
import upload_icon from '../Assets/images/login.png'
import {Formik,Field,Error} from 'formik'
                                    ...
                                    <div className="col-lg-12 col-xl-9 custom-field">
                                        <div className="cs_card_style">
                                            <div className="card-header">
                                                <input type="text" class="form-control placeholder-black input_title" placeholder="Login Information" />
                                            </div>
