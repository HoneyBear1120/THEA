...
import upload_icon from '../Assets/images/membership.png'
                            ...
                            <div className="col-lg-12 col-xl-9 custom-field">
                                    <div className="cs_card_style">
                                        <div className="card-header">
                                            <input type="text" class="form-control placeholder-black input_title" placeholder="Membership Information" />
                                        </div>
                                        <div className="card-body">
                                            <div className="form-group">
                                                <div className="row">
                                                    <div className="col-sm-5 col-lg-5  col-xl-4">
                                                        <input type="text" className="input_cs f_out" placeholder="group" />
                                                    </div>
                                            ...
                                            <div className="form-group">
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-7 col-sm-7  col-xl-8">
                                                        <div className="position-relative">
                                                            <input type="text" className="left_cs_input f_out" placeholder="website address" />
                                                            <i className=" fe  fe-minus-circle plus-circle text-danger" />
                                                        </div>
                                            ...
                                            <div className="form-group">
                                                <div className="row">
                                                    <div className="col-sm-5 col-lg-5  col-xl-4">
                                                        <input type="text" className="input_cs f_out" placeholder="telephone" />
                                                    </div>
                                                    <div className="col-lg-7 col-sm-7  col-xl-8">
                                                    <div className="position-relative">
                                                            <input type="text" className="left_cs_input f_out" placeholder="new field" />
                                            ...
                                            <div className="form-group">
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-7 col-sm-7  col-xl-8">
                                                        <div className="position-relative">
                                                            <input type="text" className="left_cs_input f_out inp_disc" placeholder="1234567891" />
                                                            <i className=" fe  fe-minus-circle plus-circle text-danger" />
                                                        </div>
