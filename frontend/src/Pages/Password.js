...
import upload_icon from '../Assets/images/pass.png'
                                    ...
                                    <div className="col-lg-12 col-xl-9 custom-field">
                                        <div className="cs_card_style">
                                            <div className="card-header">
                                                <input type="text" name="search" className="form-control placeholder-black input_title" placeholder="Login Information" />
                                            </div>
                                            <div className="card-body">
                                                ...
                                                <div className="form-group">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-lg-7 col-sm-7  col-xl-8">
                                                            <div className="position-relative">
                                                                <input type="text" className="input_cs f_out text_light" placeholder="new field" />
                                                            </div>
